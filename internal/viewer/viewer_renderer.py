...
class ViewerRenderer:
    ...
    def render_viewer(self,
        ...
        shs = self.shs[is_in_box][::sparsity] if override_color is None else None
        ...
        rets = {'render': rendered_image,
                'rend_alpha': render_alpha.unsqueeze(dim=-1), # render_alpha.repeat(3, 1, 1),
                'rend_normal': render_normal,
                'view_normal': view_normal,
                'surf_depth': surf_depth.unsqueeze(dim=-1),
    ...
    def get_outputs(self, 
        ...
        def get_result(results, type):
            if type in results.keys():
                ...
                return self.color_map(results['rend_alpha'])
            elif type == 'depth':
                return self.color_map(results['surf_depth'])
            else:
