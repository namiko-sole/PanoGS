...
class EditPanel:
    ...
    def export_mesh_block(self):
        self._default_export_log = f"**Model path**: {self.viewer.model_path} \\\n  **Data path**: {self.viewer.source_path})"
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            def update_gui_and_start_export():
                def export() -> None:
                    ...
                    ex_args, model_params, export_pipe_params = MeshExporter.parse_args_mesh(self.viewer.model_path, 
